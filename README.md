...
The code created 2ndtidy data set  which it saves in the data file “acti_subject.txt”
This code returns the mean and standard deviation of the data summarized for each test subject and for each activity category
